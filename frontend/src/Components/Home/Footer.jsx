...
const Footer = () => {
  return (
    <footer className="py-4 bg-pink-700 text-white font-mono">
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-5 px-8">
        {/* Address */}
        <div>
          <h3 className="text-xl font-semibold text-orange-200">Contact Us</h3>
          <p className="mt-2">Glow Atelier</p>
          <p>Sigra, Varanasi-221010</p>
          <p>Phone: (123) 478-3870</p>
          <p>Email: glowatelier07gmail.com</p>
        </div>
        {/* Hours */}
        <div>
